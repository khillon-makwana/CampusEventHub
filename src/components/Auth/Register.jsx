...
export default function Register() {
  ...
  async function submit(e) {
    ...
    try {
      ...
      if (data.success) {
        setMsg('Registered successfully! Check your email.');
          ...
          <div className="row justify-content-center">
            <div className="col-11 col-md-6 col-lg-5 col-xl-4">
              <div className="p-5 rounded-4 shadow-lg text-white animate__animated animate__fadeIn"
                ...
                <h2 className="mb-4 text-center fw-bold">Join EventHub</h2>
                ...
                <form onSubmit={submit}>
                  ...
                  <div className="text-center mt-3">
                    ...
                    <a href="/login" className="text-white fw-bold text-decoration-none">Login</a>
                  </div>
                </form>
              </div>
            </div>
